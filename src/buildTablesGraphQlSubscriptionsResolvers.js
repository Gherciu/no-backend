                            ...
                            subscribe : ( _,args,context ) => {
                                ...
                                if(isActionAllowed){
                                    if(context.pubsub){
                                        ...
                                        return context.pubsub.asyncIterator([`${subscriptionMethod}${firstToUpperCase(tableName)}`])

                                    }else{
                                        throw new Error('Error: pubsub is undefined, please add an instance of pubsub to context!')
                                    }
                                }else{
                    ...
                    if(isActionAllowed){
                        tablesSubscriptionsResolvers[`${subscriptionMethod}${firstToUpperCase(tableName)}`] = {
                            ...
                            subscribe : ( _,args,context ) => {
                                ...
                                let isActionAllowed = rulesReader(options.rules,rules['delete'],tableName,context.req)
